<template>
  <div class="admittance page">
    <head-title :label="'业务概况统计'" :total="total"></head-title>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="applyDate" label="申请日期" width="180" align="center"></el-table-column>
      ...
      <el-table-column prop="creditAmount" label="授信额度" align="center"></el-table-column>
      ...
      <el-table-column prop="occupiedAmount" label="已占用授信额度" align="center"></el-table-column>
      <el-table-column prop="ftCreditAmount" label="保理分配额度" align="center"></el-table-column>
    </el-table>

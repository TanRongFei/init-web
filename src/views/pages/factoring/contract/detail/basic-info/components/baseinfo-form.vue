    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form-item label="项目名称">
          <el-input v-model="form.contName" disabled />
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="合同编号" >
          <el-input v-model="form.contCode" />
        </el-form-item>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="12">
              <el-select v-model="form.prjtPlate2" placeholder="请选择" :key="linkageId" style="width:100%;">
                <el-option :label="item.name" :value="item.id" v-for="item in linkageChild" :key="item.id" />
              </el-select>
            </el-col>
          </el-row>
        </el-form-item>

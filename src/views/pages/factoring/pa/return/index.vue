<template>
  <div class="enterprise-customers page">
    <head-title
      :label="'前期款退回列表'"
      :total="total"
      @handleCheek="handleDetail('paReturnEditor')" />
    ...
    <el-table
      ...
      <el-table-column sortable prop="occupiedAmount" label="退回金额" align="center" />
      ...
      <el-table-column sortable prop="occupiedAmount" label="退回日期" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="退回方式" align="center" />
    </el-table>

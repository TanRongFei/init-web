<template>
  <div class="enterprise-customers page">
    <head-title
      :label="'前期款列表'"
      :total="total"
      @handleCheek="handleDetail('paMgrEditor')" />
    ...
    <el-table
      ...
      <el-table-column sortable prop="status" label="客户名称" align="center" />
      <el-table-column sortable prop="contCode" label="合同编号" align="center" />
      <el-table-column sortable prop="compUsccCode" label="放款编号" align="center" />
      <el-table-column sortable prop="productName" label="放款金额金额" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="保证金金额" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="保证金余额" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="收取日期" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="服务费" align="center" />
    </el-table>

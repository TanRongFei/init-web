<template>
  <div class="enterprise-customers page">
    <head-title
      :label="'保证金抵扣租金'"
      :total="total"
      @handleCheek="handleDetail('paComplementEditor')" />
    ...
    <el-table
      ...
      <el-table-column sortable prop="occupiedAmount" label="补足期次" align="center" />
      ...
      <el-table-column sortable prop="occupiedAmount" label="补足金额" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="补足日期" align="center" />
    </el-table>

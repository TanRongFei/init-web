<template>
  <div class="enterprise-customers page">
        ...
        <el-form ref="form" :model="form" label-width="80px">
          <el-form-item label="状态:">
            <el-checkbox-group v-model="form.checkList">
              <el-checkbox label="a">执行中</el-checkbox>
              <el-checkbox label="b">执行完毕</el-checkbox>
            </el-checkbox-group>
          </el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="compUsccCode" label="本息总额" align="center" />
      <el-table-column prop="productName" label="本金总额" align="center" />
      <el-table-column prop="occupiedAmount" label="利息总额" align="center" />
      <el-table-column prop="ftCreditAmount" label="已还本金" align="center" />
      <el-table-column prop="ftCreditAmount" label="剩余本金" align="center" />
      <el-table-column prop="ftCreditAmount" label="已还利息" align="center" />
      <el-table-column prop="ftCreditAmount" label="剩余利息" align="center" />
      <el-table-column prop="ftCreditAmount" label="剩余期数" align="center" />

    ...
    <el-table
      ...
      <el-table-column prop="compCode" label="客户名称" align="center">
        <template slot-scope="scope">
          <el-button type="text" @click="handleDetail('loanDetail', scope.row)">{{scope.row.credCode}}</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="compUsccCode" label="申请金额" align="center" />
      <el-table-column prop="productName" label="付款日期" align="center" />
      <el-table-column prop="occupiedAmount" label="付款金额" align="center" />
      <el-table-column prop="ftCreditAmount" label="计息方式" align="center" />
      <el-table-column prop="ftCreditAmount" label="还款计划" align="center" />
      <el-table-column prop="ftCreditAmount" label="申请人" align="center" />
      <el-table-column prop="ftCreditAmount" label="申请日期" align="center" />
      <el-table-column prop="ftCreditAmount" label="数据来源" align="center" />
    </el-table>

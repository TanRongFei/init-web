<template>
  <div class="enterprise-customers page">
    <head-title
      :label="'企业客户'"
      :total="total"
      @handleCheek="handleDetail('refundView')" />
    ...
    <el-table
      ...
      <el-table-column sortable prop="contCode" label="退款编号" align="center" />
      <el-table-column sortable prop="compUsccCode" label="来款名称" align="center" />
      <el-table-column sortable prop="productName" label="来款编号" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="退款金额" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="申请人" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="申请日期" align="center" />
    </el-table>

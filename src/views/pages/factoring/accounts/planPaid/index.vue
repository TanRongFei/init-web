<template>
  <div class="enterprise-customers page">
    ...
    <el-table
      ...
      <el-table-column sortable prop="status" label="核销编号" align="center" />
      <el-table-column sortable prop="compUsccCode" label="还款计划编号" width="180" align="center" />
      <el-table-column sortable prop="productName" label="来款名称" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="来款编号" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="来款日期" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="核销金额" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="核销人" align="center" />
      <el-table-column sortable prop="ftCreditAmount" label="制单日期" align="center" />
    </el-table>

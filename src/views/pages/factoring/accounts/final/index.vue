<template>
  <div class="enterprise-customers page">
    <head-title
      :label="'企业客户'"
      :total="total"
      @handleCheek="handleDetail('finalView')" />
    ...
    <el-table
      ...
      <el-table-column sortable prop="contCode" label="项目名称" align="center" />
      <el-table-column sortable prop="compUsccCode" label="申请转出金额" align="center" />
      <el-table-column sortable prop="productName" label="申请人" align="center" />
      <el-table-column sortable prop="occupiedAmount" label="申请时间" align="center" />
    </el-table>

    ...
    <div class="m-select-con">
      ...
      <div v-show="isAdvanSearch" class="m-select-bd p15">
        <el-form :rules="advSearchRules" size="small" :model="advSearchForm">
          ...
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="智管有方ID：" prop="beforUser">
                <el-input
                  v-model="beforUser"
                  style="width: 250px;"
                  placeholder="请输入"
    ...
    <div class="mt15">
      ...
      <div class="table-list">
        <el-table :data="tableData" highlight-current-row border stripe style="width: 100%;">
          <el-table-column prop="enableStatus" label="状态" width="180%" />
          ...
          <el-table-column prop="userId" label="智管有方ID" width="180%" />
        </el-table>
      </div>
      <!-- 分页 -->
...
<script>
import User from '@/api/CRM/userList'
export default {
  name: 'User',
  data() {
    return {

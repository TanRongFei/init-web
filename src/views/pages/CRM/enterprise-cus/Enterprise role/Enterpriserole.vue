            ...
            <el-col>
              <el-form-item label="状态：" prop="custState">
                <el-radio-group v-model="advSearchForm.compStatus" :max="1">
                  <el-radio label="15">保存</el-radio>
                  <el-radio label="20">打回修改</el-radio>
                  <el-radio label="25">审批通过</el-radio>
                  <el-radio label="30">审批不通过</el-radio>
                  <el-radio label="20">提交</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    <div class="mt15">
      ...
      <div class="table-list">
        <el-table :data="tableData" highlight-current-row border stripe style="width: 100%;">
          <el-table-column prop="bizCode" label="状态" width="180%" />
          <el-table-column prop="entpType" label="变更编号 " width="180%" />
          <el-table-column prop="compStatus" label="变更名称" width="180%" />
          <el-table-column prop="isCollect" label="企业名称" width="180%" />
          <el-table-column prop="isUscc" label="申请时间" width="180%" />
          <el-table-column prop="compName" label="经办人" width="180%" />
          <el-table-column prop="legalIdnum" label="经办人手机号" width="180%" />
